...
public:
    ...
    bool algorithm_use_dynamic_C = true;            // MGWO from Kumar et al 2016
    ...
    Optimizer(Forager *_initial_forager, size_t _max_evaluations, size_t _pack_size, bool _verbose);
